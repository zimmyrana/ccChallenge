...
• Task 7: Modify the search results to include a "More Info" button for each movie. When clicked, 
fetch and display additional details about the movie, such as the plot, director, and actors. • Task 8: Create a modal or a new section on the page to display the detailed movie information.
